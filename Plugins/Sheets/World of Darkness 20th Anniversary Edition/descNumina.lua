...
Price of Failure: In the best-case scenario, the sorcerer simply receives no visions or intuition due to failure. A botch, however, can give patently false or dangerously misleading readings. The hedge magician may divine that there’s no security at the location their coven is planning on breaking into, when the place uses enough security to rival Fort Knox. Alternatively, the sorcerer might correctly divine that a door’s lock is broken but fail to understand that the owner knows this and placed armed guards to watch it. The Storyteller should vary approaches to Divination botches lest they become predictable in and out of character.]==], pt = [==[Ler folhas de chá, lançar pedras rúnicas ou ossos, estudar o céu noturno — todos esses são exemplos de práticas tradicionais de Divinação (Divination), cujas variações abrangem uma infinidade de culturas. Desde que existe o conceito de futuro, existem pessoas querendo saber o que ele lhes reservava. Algumas das práticas mais recentes, embora mais difíceis, envolvem o uso de programação avançada de computadores baseada em ciências extraordinárias e hipermatemática (hypermath).
...
Price of Failure: Dealings with spirits can be dangerous, especially at the early stages when all a magician can do is get the attention of whatever is nearby. Even at the higher levels, the most dangerous thing possible on a botch is to call the wrong spirit, with banes being particularly common.]==], pt = [==[Alguns magos — aqueles que se concentram no Caminho da Convocação, Vinculação e Proteção (Path of Summoning, Binding, and Warding) — comandam espíritos. Aqueles que seguem o Caminho da Efêmera (Path of Ephemera) buscam uma relação de maior familiaridade com eles. Para os magos que usam o Caminho da Efêmera, sua relação com os espíritos é mais como família e amigos do que senhor e servo. Quando chamam por um espírito, é um convite, não uma intimação judicial.
...
Preço do Fracasso: O controle do mago sobre essas tempestades é tênue, na melhor das hipóteses. Em uma falha, a Força-de-Vontade ainda é gasta, mas nada acontece. Desastres, porém, resultam em tempestades que saem de controle, tanto no mundo dos vivos quanto nas Terras das Sombras. Quando um mago estático perde o controle das energias deste Caminho, ele invoca um pedaço da Tempestade (Tempest). Isso faz com que os fantasmas normais fiquem desorientados e tenham dificuldade em se mover. Os espectros, por outro lado, prosperam nesse ambiente. Esses espíritos, os mais maliciosos de todos, cavalgam a Tempestade diretamente até as Terras das Sombras e têm mais facilidade para se manifestar na área pela duração que a magia teria tido.]==] },
				["Necromancy"] = { en = [==[Some things should stay buried. Chief among them: the dead. But those who follow the Path of Necromancy see things a bit differently. Like Hellfire, Necromancy has a reputation for being foul, practiced only by the worst of the worst. Unlike Hellfire, this reputation is at least somewhat deserved. Even the simplest of Necromancy spells involve forcibly bending the dead to the magician’s will, and the most powerful of them can manipulate the powers of the Shadowlands to affect the living as well.
...
Price of Failure: Failure for most Paths simply results in nothing happening. For Necromancy, the despair of generations overwhelms them, resulting in a derangement, usually severe depression, for an hour. If they have less than three temporary Willpower points, then the derangement instead lasts a week. Botches are truly dangerous, with not only the derangements lasting longer (a full month) and the near certainty of very angry ghosts, but the magician runs the risk of being pulled out of his body, leaving it apparently comatose while their mind spends the month “living” as one of the restless dead.]==], pt = [==[Algumas coisas deveriam permanecer enterradas. A principal delas: os mortos. Mas aqueles que seguem o Caminho da Necromancia (Necromancy) veem as coisas de um modo um pouco diferente. Assim como o Fogo do Inferno (Hellfire), a Necromancia tem a reputação de ser algo vil, praticado apenas pelos piores dos piores. Diferentemente do Fogo do Inferno, essa reputação é, ao menos em parte, merecida. Até os mais simples feitiços de Necromancia envolvem dobrar os mortos à força à vontade do mágico (magician), e os mais poderosos deles podem manipular os poderes das Terras das Sombras (Shadowlands) para afetar também os vivos.
...
Preço do Fracasso: Quando um metamorfo comete um desastre, o melhor cenário consiste em uma transformação inesperada e desagradável. Ele também pode se perder em sua outra forma, tornando-se funcionalmente feral. No pior cenário, pode experimentar um descontrole violento semelhante ao Defeito Berserker/Atavismo de Estresse (Berserker/Stress Atavism Flaw) (Mage 20 p. 644).]==] },
				["Starlight"] = { en = [==[There are Paths that go back centuries and then there are some that only arise from the unique environments of the modern night. Urban sprawls gave sorcerers a unique worldview and provided a compass for the lands beyond the Shroud. Peering into the lands of the dead is not a new concept to the magical community, but those who walk the concrete valley started to see a pattern in the stars of the Shadowland skies that matched the lights of their cities. Through study and the broadening of their understanding, the Path known as Starlight was born. Much to the dismay and jealousy of the inhabitants of the Shadowlands, only those gifted in Starlight seem able to see the stars that they use.
...
Price of Failure: The Path of Summoning, Binding, and Warding has no need for special failure or botch costs. Instead, the consequences of failures and botches are visited upon the magician by the being summoned. The biggest source of these problems is that, on a botch, the magician often ends up under the mistaken impression they have succeeded.]==], pt = [==[Feiticeiros, tanto na ficção quanto na lenda, são bem conhecidos por sua capacidade de invocar e controlar outros, tanto vivos quanto efêmeros. Com esses poderes, o mago pode invocar animais, espíritos, fantasmas, demônios e outros seres estranhos. Ele também pode se defender desses seres, vinculá-los e obrigá-los a obedecer ao mago. Embora exista sobreposição com o Caminho do Efêmero (Ephemera), este Caminho se concentra em métodos de coerção, em vez de cooperação, com os seres sendo chamados e tratados.
...
Preço do Fracasso: Até mesmo efeitos intencionais de controle do clima podem ter consequências indesejadas no ambiente, tanto próximo quanto distante. Perturbações em padrões climáticos não são assunto pequeno. Um desastre, porém, desencadeia efeitos terríveis dependendo da natureza das mudanças buscadas. Relâmpagos podem atingir diretamente o feiticeiro ou seus aliados. Um clima árido pode ser atingido por uma monção que o solo não consegue acomodar, levando a inundações generalizadas. O clima local e possivelmente a área circundante sofrem mudanças dramáticas, talvez duradouras. Isso pode causar uma crise para a fauna local, a vida vegetal e as pessoas que não tiveram tempo de se preparar e podem não saber como lidar com o novo clima. A morte, mesmo que não imediata, é infelizmente um risco comum quando feiticeiros brincam com o clima.]==] },
				["Animal Psychics"] = { en = [==[Some people are naturally good with animals, and some psychics supernaturally so. This ability allows a psychic to exert their will to communicate with and control animals. Even the lowest expression of this Phenomenon allows a psychic to put an animal at ease by bridging the communication gap, rendering it more inclined to respond positively to the psychic.
...
••••• Swarm (Enxame): Com o domínio deste Fenômeno, um psíquico agora pode usar qualquer habilidade inferior em todos os animais que o psíquico consiga sentir por meio de sentidos mundanos de uma só vez. O controle do psíquico não está mais limitado a uma espécie por vez. Usar Mind Link desta forma pode rapidamente se tornar perigoso, pois cada animal vinculado representa um risco de dano por contragolpe se for ferido. A distração de manter múltiplos vínculos mentais é avassaladora, infligindo uma penalidade de -3 dados a todos os testes baseados em Atributos até que o Mind Link termine, a menos que o psíquico gaste um ponto de Força-de-Vontade ao fazer o teste para temporariamente superar a distração.]==], },
				["Anti-Psychic"] = { en = [==[Anti-Psychic is the rarest psychic phenomenon. That said, it is very subtle. Many Anti-Psychics go through life unaware of their ability. It often takes an attack by, or other serious misunderstanding with, another psychic before the Anti-Psychic learns of their gift.
...
••••• 40-yard radius. Add +5 difficulty to psychic phenomenon activation within the radius and +3 difficulty to Mind Sphere rolls. Add +3 difficulty for use of any mental-based Night Folk powers.]==], pt = [==[Anti-Psychic é o fenômeno psíquico mais raro. Dito isso, é muito sutil. Muitos Anti-Psychics (Antipsíquicos) atravessam a vida sem saber de sua habilidade. Muitas vezes é preciso um ataque de, ou outro desentendimento grave com, outro psíquico antes que o Anti-Psychic descubra seu dom.
...
••••• Odyssey: The psychic's astral travel abilities are legendary. The psychic can travel anywhere on or in Earth, extending to at least the edge of the atmosphere. Attempting to go further requires a Willpower roll at difficulty 9. So long as the psychic's body lives, including aid with life support technology, the psychic may travel indefinitely. If manifested, the psychic may speak in normal volumes and may choose to either appear in an indistinct, translucent form or deceptively opaque and may stay manifested for up to an hour per point of Willpower spent. The psychic may choose to show up on recordings.]==], pt = [==[Astral Projection permite que o psíquico separe seu espírito, mente ou consciência — ou uma combinação destes, dependendo da crença — de seu corpo. A forma astral é intangível e pode cobrir vastas distâncias em pouco tempo, pois não está sujeita às leis normais da física. Viajantes astrais podem espiar e até visitar os reinos de ideias da Umbra Astral (veja Mage 20 p. 94). O psíquico que usa Astral Projection não pode afetar o mundo físico por meios normais, embora possa fazê-lo por meio de outros fenômenos psíquicos com +2 de dificuldade. Um desastre na ativação de Astral Projection causa um contragolpe psíquico desorientador, impedindo o psíquico de deixar seu corpo por 24 horas.
...
••••• Odyssey (Odisseia): As capacidades de viagem astral do psíquico são lendárias. O psíquico pode viajar para qualquer lugar sobre ou dentro da Terra, estendendo-se ao menos até a borda da atmosfera. Tentar ir mais longe exige um teste de Força-de-Vontade com dificuldade 9. Enquanto o corpo do psíquico viver, incluindo com auxílio de tecnologia de suporte à vida, o psíquico pode viajar indefinidamente. Se manifestado, o psíquico pode falar em volume normal e pode escolher aparecer em uma forma indistinta e translúcida ou enganosamente opaca, e pode permanecer manifestado por até uma hora por ponto de Força-de-Vontade gasto. O psíquico pode escolher aparecer em gravações.]==], },
				["Biocontrol"] = { en = [==[Most psychic phenomena involve the perception or control of things outside the psychic’s body, but Biocontrol allows the psychic to exert will over their body itself. A psychic can ignore pain, enhance senses, and even divert circulation or regulate hormonal levels at will.
...
••••• Biological Mastery (Maestria Biológica): O psíquico alcança controle completo sobre seu corpo. Pode parar e reiniciar seu coração à vontade, regular a digestão, suspender temporariamente a necessidade de oxigênio e se colocar em hibernação para forçar feitos de cura mais extremos — inclusive regenerar partes do corpo. Pode acelerar ou suspender a regeneração em nível celular e pode anular toxinas com um teste de ativação. Cada sucesso de ativação reduz em um o Índice de Toxina (Toxin Rating) da substância. Se o Índice de Toxina restante for menor que o Vigor do psíquico, o psíquico pode direcionar a toxina para uma parte específica de seu corpo para que ela siga seu curso, sofrendo um Impediment (Impedimento) (como o defeito, ver M20 Book of Secrets p. 39) pela duração do efeito da toxina. Se o Índice de Toxina for maior que o Vigor do psíquico após usar Biological Mastery, o psíquico sofre a toxina normalmente no Índice de Toxina reduzido. Um psíquico pode gastar um turno se concentrando e rolar ativação para absorver dano letal e agravado com Vigor por uma cena.]==] },
				["Channeling"] = { en = [==[A medium stands before a group and calls forth a dead relative with some letter of the alphabet for a name. Some attendee says they know someone dead with that name. The medium lets them know that they crossed over peacefully, and the spirit wants the best for them. They forgive the living for some vague sin that the attendee acknowledges, and nothing further is asked. Solace has been achieved and the medium gets paid. The reality show does great, and popularity grows. That’s all crap.
...
••••• A fortaleza mental do psíquico se ergue impenetrável ou o labirinto infinito se torna inavegável. O Psíquico recebe 10 dados para conter fenômenos de ataque mental e 5 dados para ataques mentais de outras fontes.]==] },
				["Precognition"] = { en = [==[The psychic experiences clues about the future. The future isn't fixed and may change depending on the choices people make. The more decisions required for an outcome, the lower the prediction accuracy. No seer has proven 100 percent accurate, except for the mythical Cassandra.
...
Providing information about the far future can be difficult for the Storyteller. The Storyteller may instead grant one reroll for every precognition success for the story. This represents the psychic's ability to juggle relative future probabilities. A psychic may use as many of these rerolls on a single action as they wish.]==], pt = [==[O psíquico experimenta pistas sobre o futuro. O futuro não é fixo e pode mudar dependendo das escolhas que as pessoas fazem. Quanto mais decisões forem necessárias para um resultado, menor a precisão da previsão. Nenhum vidente provou ser 100 por cento preciso, exceto a mítica Cassandra.
...
••••• Psychic Surgery (Cirurgia Psíquica): O psíquico agora pode curar ferimentos graves, cânceres e infecções. O psíquico cura até 1 de dano agravado por sucesso. Cada nível curado leva 10 minutos, enquanto o psíquico fecha os olhos e gesticula como se estivesse enfiando as mãos na carne. Curandeiros também podem usar essa habilidade para causar dano, alcançando o interior de uma vítima e removendo fisicamente tecido saudável — um processo horrível e sangrento. Fora de combate, o psíquico pode usar esse poder para infligir dano agravado em um alvo contido. Como na cura, essa aplicação do poder leva 10 minutos por nível de Vitalidade. Cada sucesso na rolagem de ativação causa um nível de Vitalidade de dano agravado impossível de absorver. Esse uso da cura psíquica é sádico e considerado tortura, mas, em combate, não há tempo suficiente para usar esse poder em toda a sua extensão. Psychic Surgery só pode ser usada em combate para causar dor — ela inflige penalidades de ferimento como se o psíquico tivesse ferido o alvo, mas não causa dano. A vítima pode gastar pontos de Força-de-Vontade iguais aos sucessos de ativação do psíquico para “curar” o dano.]==] },
				["Psychic Hypnosis"] = { en = [==[While modern hypnosis is a form of therapy anyone could learn, some psychics have a natural gift for it with effects far beyond the trained variety. With the increase in popularity and recent research on hypnotherapy, psychic hypnotists can practice their gifts in the open without much fear of attracting the wrong attention.
...
Both refined actions of the phenomenon receive upgrades at this level. Levitation is now second nature and can be performed while lifting other targets, and Psychokinetic assaults may now cause bashing or lethal damage.]==], pt = [==[De vez em quando, surge um vídeo no YouTube, um especial de TV, um programa de variedades ou um livro publicado sobre algum mestre iluminado que expandiu a mente até o ponto de conseguir dobrar uma colher ou deslocar um livro 6 polegadas sobre uma mesa. Toda pessoa que assiste ou lê sobre esses feitos fica admirada e maravilhada com a possibilidade de mover objetos pela pura força da mente.
...
••••• Catalog (Catálogo): O psíquico pode usar Tether em qualquer evento ao qual o objeto esteve associado, não apenas naqueles com o maior impacto emocional.]==] },
				["Psychoportation"] = { en = [==[Psychoportation, also sometimes called teleportation, is a powerful psychic ability to suddenly be elsewhere. This is one of the more powerful and rare psychic phenomena. The occasional narrow-minded Correspondence Sphere Mage has been put in their place by watching a simple psychic psychoport out of danger’s way without earning Reality’s ire.
...
••••• Por insidioso que seja, o telepata agora pode implantar pensamentos subversivos nas mentes de seus alvos. Esses pensamentos podem ser de qualquer coisa, mas qualquer linha de pensamento que ainda não estivesse presente na mente do alvo requer uma rolagem de Manipulação + Lábia (dificuldade 7) para implantar pensamentos que complementem a personalidade e os desejos do alvo. Pensamentos implantados que vão contra a personalidade e os desejos do alvo sofrem +2 de dificuldade na rolagem. Caso esses pensamentos criem raízes, o alvo começará a agir de acordo com eles na primeira oportunidade conveniente, convencido de que os pensamentos são seus.]==] },
				...
				["True Faith"] = { en = [==[Systems for True Faith
...
• Finding yourself at the side of a friend in desperate need]==], pt = [==[Sistemas para a Fé Verdadeira
