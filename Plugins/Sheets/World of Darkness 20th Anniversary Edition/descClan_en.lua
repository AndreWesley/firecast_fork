-- Clan/bloodline descriptions, the en half (SPEC I21, I102e, V210, V24 / T848).
--
...
No wise Prince turns his back on the Brujah, and rare is the Brujah who would allow herself to be manipulated or pandered to. A Brujah is her own master, first and foremost, and those who would bring her to heel face a

terrible task. A Brujah who thinks she’s getting the short end of the stick will tear an enemy to ribbons first and maybe remember to ask questions later, no matter if he’s a Primogen or a mortal authority.

Some Kindred historians claim that the Brujah have parlayed their ancient betrayal into a role as agitators against the very order that they help support. Others claim the Brujah have long since submitted to the will of that same order, being little more than loyal opposition rendered impotent. Most Brujah don’t care either way, as long

as someone needs a good ass-kicking and they can be the ones to deliver it.]==],
				},
				["Followers of Set"] = {
...
In public view, the Giovanni make a great show of humility and respect. Part of this gentility is a habit of centuries, still in place from when the other Clans hunted the usurping Necromancers (and to preserve their hardwon neutrality from the conflict between the Camarilla

and the Sabbat). Another part of it is the velvet glove hiding the iron fist of their nature, remarkable for forcing ghosts, minds, and bodies alike to bow to their needs. To hear the Giovanni tell it, Princes and Archbishops alike owe them favors, and anyone with something to offer may earn their patronage.

For the most part, the Giovanni participate little in the Jyhad, pursuing their own agenda of cultivating wealth and building a foundation of power in the lands beyond the veil of death. Outsiders rarely comprehend the goals of the Necromancers, but only the most trusted of the Giovanni know that the Clan wants to plunge the world into a state where the dead and the living commingle.

And with their mastery of Necromancy, the Giovanni would be positioned to rule it all.]==],
				},
				["Lasombra"] = {
...
To the mind of a Lasombra, it is better to reign in hell than to serve in heaven. Fear, frenzy, the power to determine whether another lives or dies: these are at the root of the power that the Lasombra hold dear. Whereas other vampires try vainly to hold the Beast at bay or give themselves wholly to it, the Lasombra beat

the Beast into submission, invoking it when it suits them but leaving it trapped inside when they wish to govern themselves.

It is with these predilections that the Lasombra style themselves a “dark nobility,” an aristocracy of the night that chose the supremacy of the Cainites over
...
Those who doubt that the Embrace is a curse need look no further than the Nosferatu. Twisted by the mark of Caine, members of Clan Nosferatu are warped by the Embrace into hideous monsters. As such, they skulk and keep to the shadows, and they often rouse the ire and mockery of other Kindred for their nightmarish appearances. Still others are so terrified or revolted by the Nosferatu that these warped Kindred have little

social interaction at all.

To their credit, the Nosferatu come to possess many of the whispered secrets of their reluctant fellows. The Sewer Rats enjoy a grudging respect as the infor-

mation-brokers of the Kindred, given their supernatural acumen at stealth and the fact that many Kindred would rather ignore them than acknowledge them. Savvy Nosferatu exploit this for all it’s worth, turning the hypocrisy of other vampires to their own profit.
...
Toreador culture is a mixture of sybarites, dilettantes, and visionaries. Some Toreador, with echoes of mortal passion, Embrace lovers or “project” progeny who seem to fly in the face of every Toreador custom. These either don’t last long or rise to great prominence as subversives and individualists. Ideas, trends, and

“the next great thing” spread through the Clan, and other Kindred often look to the Toreador to guide them. The Degenerates know this, and many become Harpies, Princes, and other key figures in vampiric society.]==],
				},
				["Tremere"] = {
...
Tonight, the Ventrue are a synthesis of the modern and the ancient, often in stark contrast within the Clan and among one another. Theirs is money of old, from the vaults of Croesus, but their young manipulate stock markets and influence

currencies. Elders may command armies or even whole governments, while neonates conjure their assets from a website or smartphone app. But for all their wealth, their distinguished history, and their status among the Damned, each and every Ventrue must still seek that one resource that makes Kindred society egalitarian:
...
The Baali do still exist, though. The Inquisition weeded out the stupid and the careless, but left the clever and the patient. Some went into torpor, while others simply claimed membership in another Clan and begged for sanctuary. Now, in modern nights, the bloodline sees more concentrated activity than it has for centuries. Baali are explorers and seekers of secrets. They will do almost anything and sacrifice almost anyone to gain access to occult mysteries. They squander

the wealth they have accumulated, they make deals they cannot possible hope to live up to, and they do so with no apology and no attempt at excuse. They seem to know that they are in decline, and that their bloodline is disappearing into the mists of time.
...
The Blood Brothers are Kindred only in a very loose sense. They are Sabbat shock troops, created by Tremere and Tzimisce sorcerers in order for the Sword of Caine to have loyal soldiers that can still pass for human. The process of creation (for the Blood Brothers do not undergo an Embrace) washes away any individuality and personality, leaving only strong, savage, and near-mindless quasi-vampires.

Blood Brothers are usually created in small groups of three to 10. These groups — called “circles” — become family units connected by a kind of hive mind. The Sabbat also usually arranges for a Tzimisce to fleshcraft the circle’s faces so that they are identical.

The Frankensteins are a secret weapon for the Sabbat for several reasons. The Sabbat finds that while the loyalty of the Blood Brothers is beyond reproach, they don’t possess much in the way of creativity. They aren’t capable of trickery, clever tactics, or improvisation, and unless another vampire can direct them in the field in real time (which isn’t impossible, given modern communication technology), they aren’t good for much beyond simple, direct missions. Second, they are difficult and risky to create. Creating a circle of Blood Brothers means killing half a dozen people. While the Sabbat doesn’t have a problem with that in itself, a pattern of disappearances can clue in mortal authorities and Camarilla watchers alike that the Sword of Caine is up to something.

Finally, the Blood Brothers are more useful as a surprise attack, and survivors of those attacks run the risk of passing along knowledge of the Brothers’ weaknesses. Creating too many, even if it were possible or practical, would mean that eventually some Camarilla Tremere would figure out how to hurt them, or even how to reverse the magic that keeps them mindless, loyal, and useful. Some rumors say that this has already happened, but that the Tremere aren’t willing to share this knowledge with the Camarilla just yet.]==],
				},
...
The Harbingers have only been members of the Sabbat for a short time, but during that time they have made themselves invaluable. The Sword of Caine, lacking Giovanni members, has difficulty dealing with ghosts. This can lead to problematic hauntings, since the Sabbat kills enough people that ghostly visitation can become an issue. The Harbingers can exorcises these vengeful shades, or, better yet, turn them into incorporeal spies and slaves. And for all of this, the Harbingers ask nothing except for favors to be repaid at a later date.
...
Samedi take the roles of enforcers and assassins in Kindred society. They don’t do it on ideological grounds, like the Assamites, and thus they find

work with Kindred who want to get what they paid for. The Samedi do not take

contracts against Nosferatu or, strangely, Giovanni Kindred without a heavy fee, speaking to some

regard or fear of these Clans. As with so many other facts about their line, the Samedi have nothing to say on the matter.]==],
				},
				["True Brujah"] = {
...
The Clan Brujah that most Kindred know in the modern nights is not, according to legend, the true lineage of the Antediluvian known as “Brujah.” The strange bloodline known as the True Brujah claim that

Brujah’s childe, Troile, committed diablerie upon him and stole control of the Clan. Brujah, it is said, was not the hot-blooded warrior/scholar that many vampires associate with the Rabble, but rather a staid, passionless introvert. Why, then, he chose to Embrace a maniac like Troile in the first place is a mystery that will likely never be fully explained.
...
Regardless of the origin, Muricia found that she was not able to create childer or blood bonds. She did, however, retain the ability to turn other Kindred (at least other Gangrel) into whatever she

had become. She kept the animalistic features that she can gained during her previous unlife, however, and it may have been her cat-like eyes that lent her bloodline its nickname.

Muricia extended the offered of “becoming Ahrimane” to any female Gangrel who wished it. She made it quite clear she was not interested in performing the process on male Kindred, though the specific reasons for this remain unclear. A few Gangrel joined her, taking havens in the southern United States and avoid contacting with other Sabbat.

The Ahrimanes were never numerous, and although they remained nominally allied with the Sabbat, Muricia made it quite clear that they were to be left alone. This isolation may have doomed them, however. In the late 1990s, all contact with the Cats ceased. Investigators found, sometime later, that their havens were empty, and no one has heard from them since. Most Sabbat believe that the Ahrimanes were destroyed, but concede

that it is possible that Muricia might have led her line on a

spiritual pilgrimage somewhere out of the Kindred’s reach.]==],
				},
				["Anda"] = {
...
The Anda were a Gangrel offshoot, created by a Methuselah called Dobrul the Brave. Dobrul, a wanderer with great respect for the Mongol hordes, Embraced several of their warriors. These vampires became the

spirit warriors of the steppe, following the nomadic Mongol tribes and protecting them from outward threats.

The Anda had intricate rites governing the Embrace of new Kindred. Once a candidate was selected, any Anda in the area met for a discussion on that candidate’s qualities. The prospective Tartar had to be an impressive warrior, but tempered enough in nature

to understand that only by protecting his tribe from outward supernatural threats could he keep it healthy enough to feed from. Once the decision was made, the prospective sire would wash the candidate in a river, a ritual funerary bathing in the Mongol tradition. He would then drain and Embrace the new vampire.
...
The Country Gangrel serve the Sabbat as assassins and scouts, using their command of animals to gather intelligence on the comings and goings of other Kindred. Travel between cities was never exactly safe, as Lupines seem to prowl any patch of land large enough to grow a few trees (or so Camarilla elders have always told their childer), but with the Hunters prowling about, looking for wayward neonates, itinerant Kindred face even more dire threats.
...
The Malkavians are insane. It is their defining feature, and while not every Lunatic is dangerous, they are all unstable and unpredictable. And so the Malkavians of the Sabbat, the vampires of the Camarilla suspect, must be even crazier. They are quite correct.

Malkavian antitribu are just as varied in dementia as their Camarilla brethren, but their madness carries with it a desperate, cloying edge. They are not satisfied with setting others on edge or forcing the “sane” vampires to challenge their own philosophies. They want — inasmuch as they can be said to collectively want anything — for the world to share their madness. Maybe they feel that their madness is overflowing, forcing its way from their minds into the minds of others through their Dementation Discipline. Whatever the case, the

Clan at large — even outside the Sabbat — seems to have heard the message.

Within the Sabbat, the Freaks take on roles appropriate to their madness. The truly vicious and uncontrollable ones are locked away in crypts and unleashed when the Sabbat needs shock and awe. The more functional Freaks lead war parties, perform ritae, or divine the future of the Sect from the entrails of their victims (often while those victims look on in horror). No matter what their role, though, the underlying goal of the Malkavian antitribu seems to be to bestow the gift of madness upon everyone around them.]==],
				},
				["Nosferatu Antitribu"] = {
					en = [==[Vampire: The Masquerade 20th Anniversary Edition, p. 430
...
The Salubri of the Sabbat are not the quiet, contemplative Kindred that seek Golconda in persecuted exile. No, these Kindred call themselves “Furies,” and they seek the blood of the Camarilla vampires — the Tremere especially — with a venomous passion. In nights past, as mentioned in the Salubri spread (p. 408), the Clan contained both healers and warriors. And now, in the modern nights, the warriors have reemerged — and stand to be counted with the Sabbat.

The Salubri antitribu are devoted to the cause of killing Camarilla vampires, but not necessarily to other Sabbat agendas. They take part in the ritae of the Sect, and they share their blood, but what truly fires them up is the chance to invade Camarilla territory and burn some Tremere. If the ancient rumors of the Salubri

warriors being honorable knights are true, then times have indeed changed. These Kindred do not know “honorable combat” from “IED.” They just want to watch their enemies crumble to dust.]==],
				},
...
The Serpents of the Light are the antitribu of the Followers of Set. They began as a splinter group, a Setite heresy that rejected the worship of the Clan’s founder as a god. This Sect made its way to Haiti, studying vodoun and the mysticism thereof, and during the 1970s came under the sway of the Sabbat. The Clan proper tried to bring the Serpents of the Light back in line with “orthodox” Setite belief, but to no avail. As with several other splinter groups of the Clans, the Serpents of the Light found the freedom of the Sword of Caine too alluring.

The bloodline’s methods are familiar to those who know the Setites. The Cobras engage in seduction and sexual manipulation in order to achieve their ends (and, of course, to find the blood they need to survive). They dabble in drugs, prostitution, and any other method they can find to bring mortals into slavery to their own vices. In fact, apart from religious outlook, very little separates them from the Followers of Set. Some Kindred wonder, in fact, if the whole schism isn’t part of some much longer and intricate scheme, one that only the eldest of the line are fully privy to.]==],
				},
				["Toreador Antitribu"] = {
					en = [==[Vampire: The Masquerade 20th Anniversary Edition, p. 432
...
The Toreador of the Sabbat are just as prone to creative expression and love of beauty as their Camarilla counterparts, but they enjoy a much higher regard within their Sect. This is because the Toreador antitribu codified much of the Sabbat’s present structure, forming its rites and expressing its philosophy in such as a way as to appeal to the young vampires of the time. They layered discourse with meaning, showing through satire, poetry, and (when necessary) straightforward explanation that the Sabbat held the keys to the future of all Cainites.
...
Centuries ago, a small group of Tremere, fearful that the Sabbat would destroy the Camarilla and their Clan in the process, defected to the smaller Sect. They offered their skills as thaumaturgists to the Sword of Caine, in exchange for safety from their former Clan.

The Sabbat, not able to turn down the benefits of blood magic (despite how much the Tzimisce objected), took them in.
...
sessed with finding a cure, an obsession which remains tonight.]==],
				},
				["Assamite Viziers"] = {
...
The Tlacique are unquestionably a Setite line, though only their vulnerability to sunlight marks them as such. They are mystics one and all, and status within the line depends in part by learning magic. In addition to their Disciplines, they practice a form of Thaumaturgy called Nahuallotl (in game terms, this Path is identical to the Path of Blood, found on p. 213, although they pay out-of-Clan costs to learn it).]==],
				},
				["Warrior Setites"] = {
					en = [==[Vampire: The Masquerade 20th Anniversary Edition, p. 435
...
Not all Followers of Set are subtle, forked-tongued seducers. A number of them prefer to walk a more martial path, becoming holy warriors for their god. The warrior Setites eschew the Obfuscate Discipline for Potence — no slinking in the dark for these serpents. They are proud and brutal soldiers for Set, and are perfectly willing to go into battle to back up their subtler brethren. They act as enforcers, assassins, and

even martyrs for the rest of the line, although thinking of them as mindless brutes is a mistake. A warrior Setite is still very much a Setite, and quite capable of leading others into all sorts of temptation. They just have the strength to make their points forcefully when necessary.
...
For the most part, other Kindred don’t differentiate between Dominate Malkavians and the main body of

the Clan. Vampires don’t carry badges detailing their acuity in the various Disciplines, after all, and it’s by no means impossible for a Malkavian to wield both powers. As with so many things related to the Moon Clan, most vampires wouldn’t know about it if the Malkavians didn’t tell them.
...
The elders of Clan Ravnos long ago divided themselves up into castes, much like mortal Indian society. In theory, only a member of a given vampire caste could Embrace a member of the appropriate mortal caste. In

practice, though, the Clan’s elders couldn’t maintain such strict control over its members, even in India, and certainly not in the rest of the world.
...
The Tremere tolerate the Gargoyles’ presence in the Camarilla as best they can — it’s not as though they can easily re-enslave them, after all. But relations are
...
them ruthlessly for any sign of betrayal. The Tremere also aren’t above planting hypnotic suggestions in their Slaves’ minds, so that if they ever do rebel, they still serve a function for the Clan.]==],
				},
				["Gargoyles (Scout)"] = {
...
The Angellis Ater are an odd bloodline, one that crosses boundaries between Baali and Lasombra. The so-called “black angels” believe that vampires are the instrument of Satan, and they worship sin and the darkness of the soul. Their Lasombra blood lets them reach into the blackness, pull it forth and manipulate it, and the black angels become dependent upon and addicted to use of the Obtenebration Discipline over time.

The bloodline has been around since at least the Middle Ages, descended in part from a powerful Baali called Azaneal. This monstrous vampire acted as a leader within the Baali line for a time, and twisted the orthodoxy of some Kindred enough to create a kind of heresy, one that was all too attractive to the Lasombra. The Clan of Shadows’ power base traditionally included the Catholic Church, and over time the Angellis Ater made at least some inroad with these pious (or pious-seeming) Lasombra. How much influence in the Church they were able to wield is not known, but they did survive the Inquisition. Angellis Ater are rare in modern nights, but they do exist.]==],
				},
				["Maeghar"] = {
...
Egyptian mythology abounds with tales of the rivalry between Set and his brother, Osiris. Knowledgeable vampires are aware that the Followers of Set claim descent from an Antediluvian who took his name from that Egyptian serpent-god (though the Setites certainly seem to think Set actually was the god). If that’s the
